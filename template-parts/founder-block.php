<section class="section founder <?= $founder ?>">
  ...
  <img src="img/founder.jpeg" alt="founder" class="founder-photo <?= $founder_photo ?>" />
  <div class="container">
    <div class="founder-content-wraper">
      <div class="founder-content">
        ...
        <p class="founder-text <?= $founder_text ?>">
        ...
        <a href="#" class="button-link hover">Подробнее о компании</a>
      </div>
    </div>
  </div>
</section>